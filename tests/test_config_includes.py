...
""")
            ...
            assert result["includes"]["shared_axes"]["common"]["values"] == ["shared1", "shared2"]
            assert result["additional_data"]["shared_axes"]["common"]["values"] == ["shared1", "shared2"]
